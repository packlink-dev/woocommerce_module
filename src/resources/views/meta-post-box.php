		...
		<li class="wide">
			<div class="pl-order-detail-section pl-create-draft">
				...
				<?php if ( QueueItem::FAILED === $draft_status->status ) : ?>
					<span><?php echo /* translators: %s: search term */ sprintf( __( 'Previous attempt to create a draft failed. Error: %s', 'packlink-pro-shipping' ), $draft_status->message ); //phpcs:ignore WordPress.Security.EscapeOutput ?></span>
					<br/>
				<?php endif; ?>
